...
@section('content')
<div class="flex">
  <h2 class="text-2xl font-semibold ">Data Mempelai Laki-laki</h2>
...
<script>
  $(document).ready(function() {
    ...
    const table = $('#dataTable').DataTable({
      ajax: {
        url: '/api/prias', // Ganti dengan URL API Anda jika menggunakan server (misalnya, /api/pria)
      ...
      columns: [{
        ...
        },
        {
          ...
          render: function(id) {
            ...
            return `
            <a href="/pria/edit/${id}" class="bg-blue-500 hover:bg-blue-700  block text-center text-white w-full font-bold py-1 px-3 rounded mr-2">Edit</a>
    ...
    $('#dataTable').on('click', '.delete-button', function() {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          $.ajax({
            url: `/api/prias/${id}`, // URL API DELETE
            type: 'DELETE',
