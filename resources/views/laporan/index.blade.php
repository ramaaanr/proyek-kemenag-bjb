...
<div class="container mx-auto px-4 py-6">
  ...
  <a href="{{ url('/laporan/tambah') }}"
    class="inline-block mb-4 bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700">
    Tambah Laporan
  </a>
  ...
  <div class="flex justify-between items-center mb-4">
    <div>
      ...
      <button class="filter-btn bg-gray-500 text-white px-4 py-2 rounded-md hover:bg-gray-700"
        data-status="">Semua</button>
      <button class="filter-btn bg-gray-400 text-white px-4 py-2 rounded-md hover:bg-gray-600"
        data-status="BELUM">Belum</button>
      @endif

      <button class="filter-btn bg-blue-400 text-white px-4 py-2 rounded-md hover:bg-blue-600"
        data-status="DIAJUKAN">Diajukan</button>
      <button class="filter-btn bg-purple-400 text-white px-4 py-2 rounded-md hover:bg-purple-600"
        data-status="DIPENDING">Dipending</button>

      <button class="filter-btn bg-red-400 text-white px-4 py-2 rounded-md hover:bg-red-600"
        data-status="DITOLAK">Ditolak</button>
      <button class="filter-btn bg-green-400 text-white px-4 py-2 rounded-md hover:bg-green-600"
          ...
          return json.map(function(laporan) {
            ...
            return {
              ...
              perkawinan: laporan.perkawinans.length > 0 ?
                `<a href="/perkawinan/${laporan.id}" class="font-semibold text-green-600 hover:text-green-800">LIHAT DATA</a>` :
                `<a href="/perkawinan/${laporan.id}" class="font-semibold text-yellow-600 hover:text-yellow-800">ISI DATA</a>`,
